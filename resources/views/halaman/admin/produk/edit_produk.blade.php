...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <a href="{{ url('/dashboard/produk') }}" class="btn btn-danger mb-3">Back</a>
            <div class="card-body">
               ...
               <form action="/update-produk/{{$produk->id}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control"  name="name_produk" id="name_produk" value="{{ $produk->name_produk }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="weight" id="weight" value="{{ $produk->weight }}">
                    </div>
                    <div class="mb-3">
                        <label for="jurusan" class="form-label">Short Description</label>
                        <input type="text" class="form-control" name="short_description" id="short_description" value="{{ $produk->short_description }}">
                    </div>
                    <div class="mb-3">
                        <label for="jurusan" class="form-label">Description</label>
                        <input type="text" class="form-control" name="description" id="description" value="{{ $produk->description }}">
                    </div>
                    <div class="mb-3">
                        <label for="jurusan" class="form-label">Slug</label>
                        <select name="slug" id="slug">
                            <option value="{{ $produk->slug }}" selected>{{ $produk->slug }}</option>
